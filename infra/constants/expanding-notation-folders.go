...
var EXPANDING_NOTATION_FOLDERS = map[string]string{
	...
	"patches":         "patch files",
	"hooks":           "Git hooks",
	"extensions":      "code extensions or plugins",
	"plugins":         "application plugins",
	"adapters":        "adapter components",
	"drivers":         "hardware or software drivers",
	"manifests":       "deployment manifests",
	"policies":        "security or compliance policies",
	"secrets":         "secret files",
	"keys":            "encryption or API keys",
