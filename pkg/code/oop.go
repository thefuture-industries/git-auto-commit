...
func ParseToStructureClass(line, lang string) *ClassSignature {
	switch lang {
...
func parseTSJSClass(line string) *ClassSignature {
	...
	return &ClassSignature{Name: name, Parent: parent, Methods: methods}
}

func parsePythonClass(line string) *ClassSignature {
...
func parseCppClass(line string) *ClassSignature {
...
func parseCSharpClass(line string) *ClassSignature {
...
func parseGoStruct(line string) *ClassSignature {
	...
	name := m[1]
	return &ClassSignature{Name: name, Parent: "", Methods: make(map[string]string)}
}

func parseJavaClass(line string) *ClassSignature {
...
func FormattedClass(diff, lang string) string {
	var oldClass, newClass *ClassSignature
