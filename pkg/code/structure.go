...
func parseStruct(line, lang string) *StructureSignature {
	...
	return &StructureSignature{Name: m[1]}
}

func parseType(line, lang string) *TypeSignature {
	...
	return &TypeSignature{Name: m[1]}
}

func parseInterface(line, lang string) *InterfaceSignature {
	...
	return &InterfaceSignature{Name: m[1]}
}

func parseEnum(line, lang string) *EnumSignature {
	...
	return &EnumSignature{Name: m[1]}
}

func FormattedStruct(diff, lang string) string {
	var oldStruct, newStruct *StructureSignature
...
func FormattedType(diff, lang string) string {
	var oldType, newType *TypeSignature
...
func FormattedInterface(diff, lang string) string {
	var oldInterface, newInterface *InterfaceSignature
...
func FormattedEnum(diff, lang string) string {
	var oldEnum, newEnum *EnumSignature
